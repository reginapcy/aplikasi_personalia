...
class Admin extends CI_Controller {
	...
	public function index()
	{
		...
		$data['data_karyawan']= $this->db->get('data_karyawan')->num_rows();
	...
	{
		$data['web']	= $this->web;
		$data['data']	= $this->db->get('data_karyawan')->result();
		$data['title']	= 'Data Karyawan';
		$data['body']	= 'admin/data_karyawan';
		$this->load->view('template',$data);
	}
	public function data_karyawan_add()
	{
		...
		$data['body']	= 'admin/karyawan_add';
		$this->load->view('template',$data);
	}
	public function data_karyawan_simpan()
	{
		$this->db->insert('data_karyawan',['data_karyawan'=>$this->input->post('data_karyawan')]);
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Tambah karyawan", "success");');
	...
	{
		$data['web']	= $this->web;
		$data['data']	= $this->db->get_where('data_karyawan',['data_karyawan_id'=>$id])->row();
		$data['title']	= 'Update Data Kayawan';
		$data['body']	= 'admin/data_karyawan_edit';
		$this->load->view('template',$data);
	}
	public function data_karyawan_update($id)
	{
		$this->db->update('data_karyawan',['data_karyawan'=>$this->input->post('data_karyawan')],['data_karyawan_id'=>$id]);
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Update data_karyawan", "success");');
		redirect('admin/data_karyawan');

	}
	public function data_karyawan_delete($id)
	{
		$this->db->delete('data_karyawan',['data_karyawan_id'=>$id]);
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Delete data_karyawan", "success");');
		redirect('admin/data_karyawan');

	}
	//EDN CURD Data Karyawan
	//CURD Pegawai
