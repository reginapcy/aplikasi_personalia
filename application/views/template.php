  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #003b6f">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block"><small>User login :</small><br> <b><?=$this->session->userdata('nama')?> ( <?=$this->session->userdata('level')?> )</b></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=base_url($this->session->userdata('level'))?>/data_karyawan" class="nav-link">
                  <i class="far fa-file nav-icon"></i>
                  <p>Data Karyawan</p>
                </a>
              </li>
